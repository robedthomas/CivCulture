...
namespace CivCulture_Model.Models.MetaComponents
{
    public abstract class MapGeneration : MetaComponent
    {
        ...
        /// <returns></returns>
        public abstract GameMap GenerateMap(MapConfiguration config, NamesDatabase namesDb, TemplatesDatabase templatesDb, Random seed, out List<Culture> allCultures, out List<Pop> allPops, out List<Job> allJobs);
    }
}
